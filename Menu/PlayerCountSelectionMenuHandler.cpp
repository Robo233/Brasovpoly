...
PlayerCountSelectionMenuHandler::PlayerCountSelectionMenuHandler()
{
    ...
    playerCountSelectionButtonInitialPositionY = 150;
    playerCountSelectionButtonDistanceBetweenButtonsY = 100;
    playerCountSelectionTextPositionY = 200;
    playerCountSelectionTextCharacterSize = 30;

    tutorialButtonPadding = 30;
    tutorialButtonSize = 45;    
}
