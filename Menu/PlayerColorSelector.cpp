...
{
    numberOfColumns = 3;
    distanceBetweenElements = 100;
    colorSelectorButtonWidth = 100;
    colorSelectorButtonHeight = 100;
    colorSelectorButtonPositionX = (Globals::windowWidth - numberOfColumns * colorSelectorButtonWidth - (numberOfColumns-1) * distanceBetweenElements)/2;
    colorSelectorButtonInitialPositionY = 225;
    colorSelectorButtonPositionY = 100;

    playerColorSelectorTextPositionY = 200;
    playerColorSelectorTextCharacterSize = 30;    
}
