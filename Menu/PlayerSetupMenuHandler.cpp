...
{
    initialPositionX = 0;
    distanceBetweenElementsX = 250;
    textPositionY = 150;
    inputFieldPositionY = 250;
    colorButtonPositionY = 350;
    colorButtonWidth = 150;
    colorButtonHeight = 50;
    inputTextPosition = 50;

    inputFieldWidth = 220;
    inputFieldHeight = 24;

    startGameButtonWidth = 200;
    startGameButtonHeight = 50;
    startGameButtonDistanceFromBottom = 100;    
}
