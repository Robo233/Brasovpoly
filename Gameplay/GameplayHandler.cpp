...
{
    percentOfPropertyPriceWhichHasToBePaidWhenPropertyIsVisited = 20;
    uiRectangleShapePlayerSize = 30;
    initialPlayerPositionX = 15;
    initialPlayerPositionY = 55;
    distanceBetweenPlayersX = 15;
    distanceBetweenPlayersY = 5;
    numberOfColumnsPlayerRectangles = 3;

    numberOfColumnsPlayerInfoTexts = 3;
    playerNameTextCharacterSize = 35;
    currentPlayerNameTextCharacterSize = 58;
    playerNameTextPositionX = 275;
    playerNameTextIntialPositionY = 250;
    distanceBetweenPlayerNameTextsX = 300;
    distanceBetweenPlayerNameTextsY = 175;
    playerProfitAmountTextPositionY = 35;

    initialMoneyAmount = 6000;
    playerMoneyAmountTextPositionY = 68;

    currentPlayerIndex = 0;

    rollDiceResultMin = 2;
    rollDiceResultMax = 12;

    delayAfterWhichNextButtonBecomesPressableAfterBuyPropertyButtonWasPressed = 0.1;

    percentOfRealEstatePriceWhichHasToBePaidToBuyAHouse = 20;
    percentOfRealEstatePriceWhichHasToBePaidPerHouseWhenRealEstateIsVisited = 10;
    numberOfHousesAfterWhichItsConsideredHotel = 4;
    numberOfHousesPerRow = 2;
    houseSpriteSize = 40;
    hotelSpriteSize = 80;
    houseSpritePositionY = 50;
    hotelSpritePositionY = 45;

    numberOfSkippedTurnsWhenPlayerisInJail = 3;

    colorOfPlayerInJailAlphaValue = 128;

    taxLocationAmount = 75; // ANAF

    minimumGamblingAmountProfit = -200;
    maximumGamblingAmountProfit = -100;

    amountOfMoneyGotByAPlayerAfterItGoesTroughStart = -10;
}
...
{
    std::cout << "hasPlayerLost " << amountToPay << std::endl;
...
void GameplayHandler::activateBuyHouseButtonIfPlayerCanBuyIt()
{
    ...
    if(currentPlayerWhichHasToThrow->getMoneyAmount() > housePrice && currentRealEstate->getHouseAmount() < numberOfHousesAfterWhichItsConsideredHotel-1)
    {
