...
InGameSceneCreator::InGameSceneCreator()
{
    propertyIndex = 1;
    locationsPadding = 90;
    locationBorderSize = 5;
    numberOfRowsAndColumnsStart = 5;
    playerIndexTextCharacterSize = 15;
    propertyColorSquareHeight = 50;

    numberOfPropertiesHorizontalUp = 7;
    numberOfPropertiesVerticalLeft = 4;
    numberOfPropertiesHorizontalDown = 8;
    numberOfPropertiesVerticalRight = 4; 

    propertyNameTextPaddingY = 10;
    propertyPriceTextPaddingY = 125;

    rollDiceResultTextPositionX = 1200;
    rollDiceResultTextPositionY = 600;

    rollDiceResultTextCharacterSize = 45;

    gameOverTextCharacterSize = 45;
    gameOverTextPositionY = 100;

    gameOverPlayingTimeTextCharacterSize = 40;

    transportPropertyTextureSize = 75;

    goToJailLocationSize = 90;
    goToJailLocationPositionY = 30;

    taxLocationSpriteWidth = 73;
    taxLocationSpriteHeight = 103.5;

    gamblingLocationSpriteSize = 110;

    rollDiceButtonPositionX = 320;
    rollDiceButtonPositionY = 592.5;

    buyPropertyButtonPositionX = 620;
    buyPropertyButtonPositionY = 592.5;

    buyHouseButtonPositionX = 920;
    buyHouseButtonPositionY = 592.5;
}
